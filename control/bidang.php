<?php
class bidang extends database{
    public function __construct($home) {
        $this->select = "SELECT * FROM bidang WHERE 1";
        $this->insert = "INSERT INTO bidang (nama)VALUES(?)";
        $this->update = "UPDATE bidang SET nama=? WHERE id=?";
        $this->delete = "DELETE FROM bidang WHERE id=?";
